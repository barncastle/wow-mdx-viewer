import { LineType, AnimKeyframe, AnimVector } from '../../formats/mdx/model';
...
export function findKeyframes(animVector: AnimVector, frame: number, from: number, to: number): null | { frame: number, left: AnimKeyframe, right: AnimKeyframe } {
    if (!animVector) {
        return null;
    }
...
export function interpVec3(out: vec3, frame: number, left: AnimKeyframe, right: AnimKeyframe, lineType: LineType): vec3 {
    if (left.Frame === right.Frame) {
...
export function interpQuat(out: quat, frame: number, left: AnimKeyframe, right: AnimKeyframe, lineType: LineType): quat {
    if (left.Frame === right.Frame) {
